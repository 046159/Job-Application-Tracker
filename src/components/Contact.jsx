            ...
            <section>
                <div className="container">
                    <form>
                        ...
                        <br></br>
                        <div className="form-group">
                            <label htmlFor="queryDescription">Your Query</label>
                            <textarea
                                className="form-control"
                                id="queryDescription"
                                rows="3"
                        ...
                        <div className="col text-center">
                            <button type="submit" onClick={handleFormSubmit} className="btn btn-primary m-3">Submit</button>
                        </div>
                    </form>
                        ...
                        <div className="container text-center">
                            <div className="row align-items-center">
                                <div className="col-lg-12">
                                    <p>
                                        <a href="mailto:sardar.jafari@gmail.com"
                                            className="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                                            sardar.jafari@gmail.com</a>
                                ...
                                <div className="col-lg-12">
                                    <p>
                                        <a href="https://www.linkedin.com/in/sardar--jafari/" target="_blank"
                                            className="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                                            LinkedIn
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <div className="col-lg-12">
                                    <p>
                                        <a href="https://github.com/046159" target="_blank"
                                            className="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                                            GitHub
